          ...
          <div className="w-full max-w-md space-y-6 p-6 sm:p-8 bg-white rounded-3xl shadow-xl border border-slate-100 animate-in fade-in slide-in-from-bottom-6 duration-500 relative z-10">
            ...
            <div className="text-center space-y-4 pt-1">
              ...
              <div className="pt-4 border-t border-slate-100">
                ...
                <a href="mailto:software.atrios@gmail.com" className="inline-flex items-center gap-2 px-3 py-1.5 bg-slate-50 border border-slate-200 rounded-xl text-[10px] font-black uppercase tracking-widest text-slate-600 hover:bg-slate-100 transition-all">
                                  ...
                                  <div className="flex items-center justify-between gap-3">
                                    <div className="flex items-center gap-2.5 min-w-0">
                                      <div className={`w-9 h-9 rounded-xl flex items-center justify-center shrink-0 transition-colors ${
                                        ...
                                        {pushSoundEnabled ? <Volume2 size={18} /> : <VolumeX size={18} />}
                                      </div>
                                      <div className="min-w-0">
                                        <label className="text-[10px] lg:text-xs font-black text-slate-700 uppercase tracking-wider block truncate">
                                          {t.pushSoundLabel}
                                        </label>
                                        <p className="text-[10px] sm:text-[11px] font-bold text-slate-400 leading-tight truncate">
                                          {pushSoundEnabled ? t.pushSoundActiveDesc : t.pushSoundMutedDesc}
                                        </p>
                                      </div>
                                    </div>
                                    ...
                                    <button
                                      ...
                                      className={`px-3.5 py-2.5 rounded-xl border-2 font-black text-[11px] uppercase tracking-wider flex items-center gap-1.5 transition-all cursor-pointer shrink-0 ${
                                        pushSoundEnabled
                                      ...
                                      title={pushSoundEnabled ? t.pushSoundDisabled : t.pushSoundEnabled}
                                    >
                                      {pushSoundEnabled ? (
                                        <>
                                          <Check size={14} className="text-emerald-200" />
                                          <span>{t.pushSoundEnabled}</span>
                                        </>
                                      ) : (
                                        <>
                                          <VolumeX size={14} className="text-slate-500" />
                                          <span>{t.pushSoundDisabled}</span>
                                        </>
                                      )}
                                    </button>
                                  </div>
