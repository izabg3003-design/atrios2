        ...
        <div className={`grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 ${!isPremium ? 'blur-[4px] pointer-events-none grayscale' : ''}`}>
          <div className="bg-white p-5 sm:p-8 lg:p-10 rounded-[2rem] lg:rounded-[3rem] shadow-sm border border-slate-100">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 lg:mb-6 gap-2">
              ...
              <div className="flex flex-wrap items-center gap-2.5 sm:gap-4">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[7.5px] sm:text-[8.5px] lg:text-[9.5px] font-black text-slate-400 uppercase">{t.totalVolume}</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-4 bg-slate-50 p-3 sm:p-4 rounded-2xl mb-6">
              <div>
                <p className="text-[7.5px] sm:text-[9px] font-black text-slate-400 uppercase tracking-tight truncate">{t.totalVolume}</p>
              ...
              <div className="border-x border-slate-200 px-2 sm:px-4">
                <p className="text-[7.5px] sm:text-[9px] font-black text-slate-400 uppercase tracking-tight truncate">{t.rejectionRate}</p>
              ...
              <div className="pl-1 sm:pl-2">
                <p className="text-[7.5px] sm:text-[9px] font-black text-slate-400 uppercase tracking-tight truncate">{t.approvalRate}</p>
            ...
            <div className="h-[200px] sm:h-[250px] lg:h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={chartData}>
                  ...
                  <Bar dataKey="value" name={t.totalVolume} fill="#3b82f6" radius={[4, 4, 0, 0]} barSize={8} sm:barSize={14} lg:barSize={20} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
